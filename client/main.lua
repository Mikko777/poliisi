	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			...
			if job == 'bullet_wear' then
				SetPedArmour(playerPed, 28)
			end

			if job == 'heavy_wear' then
			SetPedArmour(playerPed, 58)
			end
		else
			...
			if job == 'bullet_wear' then
				SetPedArmour(playerPed, 33)
			end

			if job == 'heavy_wear' then
				SetPedArmour(playerPed, 66)
			end
		end
	end)
end
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('heavy_wear'), value = 'heavy_wear' },
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'heavy_wear' or
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
            ...
            {label = "Heitä vankilaan",         value = 'jail_menu'},
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				{label = "Ruutitesti",			value = 'gsr_test'},
